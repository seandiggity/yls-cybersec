...
\noindent\textbf{Instructors:} \begin{itemize}
...
\noindent\textbf{Office Hours:} TBD
\vspace{.1cm}

\noindent\textbf{Course Websites:} \begin{enumerate}
\item Canvas CMS - \url{https://yale.instructure.com/courses/38230}
\item Additional Resources - \url{https://github.com/seandiggity/yls-cybersec}
\end{enumerate}
...
\begin{itemize}
\item \textbf{Attendance} - It is very important to attend each class -- indeed, attendance is mandatory.
\item \textbf{Homework} -  Each class will conclude with a take-home assignment.  These must be completed to the satisfaction of the instructors.
\item \textbf{Exam} - Your grade will be based on a take-home final exam.
\end{itemize}
...
\begin{enumerate}
\item Our Approach
\item Digital Self-Defense %Move to 13? %% SO - renamed this to be more like what I have in mind.
...
\item Intro to File Permissions
\item Edit a File
\end{enumerate}
...
\item Cryptomarkets %would do that last to lead over to next session.  %% SO - Sure, but I need to note to myself that attack attribution, traffic origin needs to be covered... that's obviously a big issue in international law.
\end{enumerate}
